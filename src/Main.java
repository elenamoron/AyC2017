...
public class Main extends javax.swing.JFrame {
    ...
    public void mostrarResultado(Alfombra[] alfombras, double duration){
        for (int i=0; i<alfombras.length;i++){
                alfombras[i].setAlegria(alfombras[i].sumarAlegria(alfombras[i].getRegalos()));
                jtaSolucion.append("Resultado de la alfombra "+
                        alfombras[i].getNombre()+"--"+
                        alfombras[i].getAlegria()+" de alegria en "+
                        alfombras[i].getNumRegalos(alfombras[i].getRegalos())+" regalos con ");
                if(i==0){
                    jtaSolucion.append(alfombras[i].sumarPeso(alfombras[i].getRegalos())+"/"+PesoA+" de peso\n");    
                }else if(i==1){
                    jtaSolucion.append(alfombras[i].sumarPeso(alfombras[i].getRegalos())+"/"+PesoB+" de peso\n");    
                }else{
                    jtaSolucion.append(alfombras[i].sumarPeso(alfombras[i].getRegalos())+"/"+PesoC+" de peso\n");    
                }
        }
    ...
    public void escribirFichero(Alfombra[] alfombras, PrintWriter pw, String salida ){
        try{
            pw.println("Alegria de la alfombra "+
                    ...
                    alfombras[0].getAlegria()+" de alegria en "+
                    alfombras[0].getNumRegalos(alfombras[0].getRegalos())+" regalos con "+
                    alfombras[0].sumarPeso(alfombras[0].getRegalos())+"/"+PesoA+" de peso\n");
            pw.println("Alegria de la alfombra "+
                    alfombras[1].getNombre()+"--"+
                    alfombras[1].getAlegria()+" de alegria en "+
                    alfombras[1].getNumRegalos(alfombras[1].getRegalos())+" regalos con "+
                    alfombras[1].sumarPeso(alfombras[1].getRegalos())+"/"+PesoB+" de peso\n");
            pw.println("Alegria de la alfombra "+
                    alfombras[2].getNombre()+"--"+
                    alfombras[2].getAlegria()+" de alegria en "+
                    alfombras[2].getNumRegalos(alfombras[2].getRegalos())+" regalos con "+
                    alfombras[2].sumarPeso(alfombras[2].getRegalos())+"/"+PesoC+" de peso\n");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                regalosOrdenadosAlegria = ordenarPorTasa(regalos,regalos.length);
                ...
                pw.println("Duración del algoritmo en milisegundos "+duration+"\n");
